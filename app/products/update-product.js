jQuery(function($){
  ...
  $(document).on('click', '.update-product-button', function() {
    ...
    $.getJSON("http://localhost/prg/authentication-jwt/api/v1/product/read_one.php?id=" + id, function(data) {
      ...
      $.getJSON("http://localhost/prg/authentication-jwt/api/v1/category/read.php", function(data) {
  ...
  $(document).on('submit', '#update-product-form', function(){
    ...
    $.ajax({
        url: "http://localhost/prg/authentication-jwt/api/v1/product/update.php",
        type : "POST",
        ...
        success : function(result) {
            ...
            //showProducts();
            $('#response').html("<div class='alert alert-success'>Продукт успешно обновлен.</div>");
